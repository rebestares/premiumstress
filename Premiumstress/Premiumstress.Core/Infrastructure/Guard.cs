...
namespace Premiumstress.Core.Infrastructure
{
    public class Guard
    {
       ...
       // [DebuggerStepThrough]
        ...
        //{
        //    HasDefaultConstructor(type of (T));
        //}
        ...
        public static void PagingArgsValid(int pageIndex, int pageSize, string pageindex, string pagesize)
        {
